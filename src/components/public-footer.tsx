...
export default function PublicFooter() {
  return (
    <footer className="w-full bg-pine text-paper">
        ...
        <div className="flex flex-col gap-10 lg:flex-row lg:items-end lg:justify-between">
          <div className="max-w-xl">
            ...
            <p className="mt-4 font-display text-4xl font-medium leading-[1.02] tracking-tight sm:text-5xl">
              Rumah yang dirawat,
              <br />
              <em className="font-light text-paper/85">pengelola yang dikenal.</em>
            </p>
          </div>
          <a
            href={WA_LINK}
            ...
            className="group flex items-center gap-4 rounded-[1.75rem] bg-paper/[0.07] p-4 pr-6 ring-1 ring-paper/15 backdrop-blur transition-all duration-300 hover:bg-paper hover:text-pine"
          >
            <span className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-gold text-pine transition-transform duration-300 group-hover:scale-105">
              <WhatsAppIcon className="h-5 w-5" />
            </span>
            <span className="min-w-0">
              <span className="block font-mono text-[10px] uppercase tracking-[0.2em] text-paper/60 group-hover:text-pine/60">
            ...
            <ArrowUpRight className="ml-2 h-5 w-5 text-paper/50 transition-all group-hover:translate-x-0.5 group-hover:text-pine" />
          </a>
        </div>
        ...
        <div className="mt-12 grid w-full gap-10 border-t border-paper/15 pt-10 sm:grid-cols-2 lg:grid-cols-[1.3fr_1fr_1fr_1.2fr]">
          <div>
            <Link href="/" className="flex items-center gap-2.5" aria-label="Kelola Kontrakan — Beranda">
              <span className="flex h-10 w-10 items-center justify-center rounded-2xl bg-paper text-pine">
          ...
          <div>
            ...
            <address className="mt-4 space-y-3 text-sm not-italic leading-6 text-paper/80">
          ...
          <div className="rounded-[1.75rem] bg-paper/[0.06] p-6 ring-1 ring-paper/12">
            <p className="font-mono text-[11px] uppercase tracking-[0.2em] text-paper/50">
              Jam survei
            </p>
            ...
            <Link href="/kontrakan" className="mt-5 inline-flex items-center gap-2 rounded-full bg-paper px-5 py-2.5 text-sm font-bold text-pine transition hover:bg-goldsoft">
      ...
      <div className="w-full border-t border-paper/12">
        <div className="shell flex w-full flex-col gap-1 py-5 font-mono text-[11px] uppercase tracking-[0.14em] text-paper/45 sm:flex-row sm:items-center sm:justify-between">
